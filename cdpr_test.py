...
class CDPR:
    ...
    def __init__(self):
        ...
        self._anchorA1 = np.array([0.759, 0.778, -0.229]) - self.pos_off
        self._anchorA2 = np.array([0.082, 0.786, -0.230]) - self.pos_off
        self._anchorA3 = np.array([0.080, 0.097, -0.224]) - self.pos_off
        self._anchorA4 = np.array([0.769, 0.103, -0.226]) - self.pos_off
        ...
        Ot = np.array([0.424, 0.438, -0.449]) - self.pos_off
        Om1 = np.array([0.536, 0.550, -0.612]) - self.pos_off
        Om2 = np.array([0.312, 0.550, -0.612]) - self.pos_off
        Om3 = np.array([0.312, 0.325, -0.612]) - self.pos_off
        Om4 = np.array([0.536, 0.325, -0.612]) - self.pos_off
        Ob1 = np.array([0.536, 0.550, -0.808]) - self.pos_off
        Ob2 = np.array([0.312, 0.550, -0.808]) - self.pos_off
        Ob3 = np.array([0.312, 0.325, -0.808]) - self.pos_off
        Ob4 = np.array([0.536, 0.325, -0.808]) - self.pos_off
